...
Write-Host "Checking for updates (Atlas)..." -ForegroundColor Cyan

$apiUrl = "https://api.github.com/repos/GRILLYje/Fishing_Atlas_public/releases/latest"
...
Write-Host "Launching Atlas..." -ForegroundColor Green
